...
class RenderSystem {
	...
	const std::array<std::string, texture_count> texture_paths = {
			...
			textures_path("artifacts/belt.png"),
			textures_path("artifacts/bloody_ruby-1.png"),
			textures_path("artifacts/book_thick.png"),
			textures_path("artifacts/demon_arm_option_2.png"),
			textures_path("artifacts/fang.png"),
			textures_path("artifacts/florescent_mushroom.png"),
