...
enum class TEXTURE_ASSET_ID {
	...
	INTERACT_POINTER = ARTIFACT_PLACEHOLDER + 1,
	BG_ROOM = INTERACT_POINTER + 1,
...
enum class ObjectiveType {
	...
	TUTORIAL = DEFEAT_BOSS + 1,
	OBJECTIVE_COUNT = TUTORIAL + 1
};
...
enum class TRANSITION_TYPE {
	...
	CUTSCENE_TO_HOSPITAL = GAME_TO_FINAL_CUTSCENE + 1,
	CUTSCENE_TO_BLACK = CUTSCENE_TO_HOSPITAL + 1,
	CUTSCENE_TO_GAMEOVER = CUTSCENE_TO_BLACK + 1,
...
const std::map <ARTIFACT, std::string>artifact_descriptions = {
	...
	{ARTIFACT::BLADE_POLISH, "\"There you go, just like brand new.\""},
	{ARTIFACT::HQ_FLETCHING, "\"Why do you need this if all you're using is a sword?\" \"Just in case.\""},
	...
	{ARTIFACT::THUNDER_TWIG, "Oh yea, I remember finding this weird charred stick in the park after that big storm last nigh- Wait. What park? And when again?"},
	...
	{ARTIFACT::GOLIATH_BELT, "\"Oh right, This is the belt I use for...wait what was it again?\""},
	{ARTIFACT::BLOOD_RUBY, "It has a sticker on the back with the words \"Property of Professor Hammond\". It also mentions that this was a failed attempt at creating a \"Philosopher's Stone\", but what does that even mean?"},
