...
enum class TEXTURE_ASSET_ID {
	...
	ARROW_FEATHER = POTION_YELLOW + 1,
	BASEBALL_CAP = ARROW_FEATHER + 1,
	BELT = BASEBALL_CAP + 1,
	BLOODY_RUBY = BELT + 1,
	BOOK_THICK = BLOODY_RUBY + 1,
	DEMON_ARM = BOOK_THICK + 1,
	FANG = DEMON_ARM + 1,
	FLORESCENT_MUSHROOM = FANG + 1,
	FUNNEL = FLORESCENT_MUSHROOM + 1,
	GREEN_BOOK = FUNNEL + 1,
	PLANT_BULB = GREEN_BOOK + 1,
	POKER_CHIP = PLANT_BULB + 1,
	POUCH = POKER_CHIP + 1,
	POUCH_DIFF = POUCH + 1,
	POWDER_POUCH = POUCH_DIFF + 1,
	ROUND_METAL_SHEILD = POWDER_POUCH + 1,
	RUBBER_MALLET = ROUND_METAL_SHEILD + 1,
	SCROLL = RUBBER_MALLET + 1,
	TWIG = SCROLL + 1,
	FUR_COAT = TWIG + 1,
	TEXTURE_COUNT = FUR_COAT + 1
};
...
const std::map <ARTIFACT, TEXTURE_ASSET_ID>artifact_textures = {
	{ARTIFACT::POISON_FANG, TEXTURE_ASSET_ID::FANG},
	{ARTIFACT::GLAD_HOPLON, TEXTURE_ASSET_ID::ROUND_METAL_SHEILD},
	{ARTIFACT::BLADE_POLISH, TEXTURE_ASSET_ID::ARTIFACT_PLACEHOLDER}, // ? pouch_difff?
	{ARTIFACT::HQ_FLETCHING, TEXTURE_ASSET_ID::ARROW_FEATHER},
	{ARTIFACT::MESSENGER_CAP, TEXTURE_ASSET_ID::BASEBALL_CAP},
	{ARTIFACT::WARM_CLOAK, TEXTURE_ASSET_ID::FUR_COAT},
	{ARTIFACT::THUNDER_TWIG, TEXTURE_ASSET_ID::TWIG},
	{ARTIFACT::LUCKY_CHIP, TEXTURE_ASSET_ID::POKER_CHIP},
	{ARTIFACT::GUIDE_HEALBUFF, TEXTURE_ASSET_ID::GREEN_BOOK},
	{ARTIFACT::THICK_TOME, TEXTURE_ASSET_ID::BOOK_THICK},
	{ARTIFACT::GOLIATH_BELT, TEXTURE_ASSET_ID::BELT},
	{ARTIFACT::BLOOD_RUBY, TEXTURE_ASSET_ID::BLOODY_RUBY},
	{ARTIFACT::WINDBAG, TEXTURE_ASSET_ID::POUCH},
	...
	{ARTIFACT::ART_CONSERVE, TEXTURE_ASSET_ID::SCROLL},
	{ARTIFACT::ARCANE_FUNNEL, TEXTURE_ASSET_ID::FUNNEL},
	{ARTIFACT::FUNGIFIER, TEXTURE_ASSET_ID::FLORESCENT_MUSHROOM},
	{ARTIFACT::BURRBAG, TEXTURE_ASSET_ID::POUCH_DIFF},
	{ARTIFACT::SMOKE_POWDER, TEXTURE_ASSET_ID::POWDER_POUCH},
	{ARTIFACT::LIVELY_BULB, TEXTURE_ASSET_ID::PLANT_BULB},
	{ARTIFACT::MALEDICTION, TEXTURE_ASSET_ID::ARTIFACT_PLACEHOLDER},
	{ARTIFACT::CHIMERARM, TEXTURE_ASSET_ID::DEMON_ARM}
};
